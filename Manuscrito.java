...
public class Manuscrito extends ItemAcervo {
    ...
    public Manuscrito(int codigo, String titulo, LocalDate dataAquisicao, String estadoConservacao, boolean raro,
            boolean disponivel, String autor, String datacao, String estadoOriginal) {
